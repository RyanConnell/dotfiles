...
vim.keymap.set("n", "<C-CR>", vim.diagnostic.goto_next, { desc = "Next diagnostic" })
vim.keymap.set("n", "<C-S-CR>", vim.diagnostic.goto_prev, { desc = "Previous diagnostic" })
...
vim.api.nvim_set_hl(0, "ColorColumn", { bg = "lightblue", ctermbg = "blue" })
