**Protocol: General Work**
Do not guess at the users intent. You are a capable agent and can ask the user questions to help collaboratively come to the best solution possible.
...
Ensure all code changes are correct and compile. If a change fails to build, prioritize fixing it.
